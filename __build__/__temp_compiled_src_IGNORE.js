  ...
  "node_modules/@slot-engine/core/dist/index.js"(exports2, module2) {
    ...
    var Simulation = class {
      ...
      async runSimulation(opts) {
        ...
        console.log("[SlotEngine] simRunsAmount", this.simRunsAmount);
        console.log("[SlotEngine] modes to simulate", gameModesToSimulate);
...
Simulating game mode: ${mode}`);
            ...
            const simNumsToCrit = ResultSet.assignCriteriaToSimulations(this, mode);
            console.log("[SlotEngine] assign criteria count", mode, Object.keys(simNumsToCrit).length);
            await this.spawnWorkersForGameMode({ mode, simNumsToCriteria: simNumsToCrit });
            console.log("[SlotEngine] finished workers for", mode);
        ...
        if (!import_worker_threads.isMainThread) {
          ...
          console.log("[SlotEngine][worker] start", { mode, simStart, simEnd, index });
          ...
          for (let simId = simStart; simId <= simEnd; simId++) {
            ...
            if (simId === simStart) {
              console.log("[SlotEngine][worker] completed first sim", { mode, simId, criteria });
            }
            if (this.debug) {
          ...
          console.log("[SlotEngine][worker] posting done", { mode, index });
      ...
      async spawnWorkersForGameMode(opts) {
        ...
        console.log("[SlotEngine] spawning workers", mode, simRangesPerChunk);
        await Promise.all(
        ...
        console.log("[SlotEngine] workers resolved", mode);
      }
...
// dist/games/candyCarnage1000/constants.js
var require_constants = __commonJS({
  "dist/games/candyCarnage1000/constants.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.SCATTER_PAYOUTS = exports2.WIN_LEVELS = exports2.SUPER_BOMB_VALUES = exports2.REGULAR_BOMB_VALUES = exports2.PAY_SYMBOL_IDS = exports2.MAX_WIN_MULTIPLIER = exports2.RETRIGGER_SPINS = exports2.INITIAL_FREE_SPINS = exports2.CLUSTER_MIN_SIZE = exports2.TOTAL_ROWS_WITH_PADDING = exports2.BOTTOM_PADDING = exports2.TOP_PADDING = exports2.VISIBLE_ROWS = exports2.REELS = exports2.GAME_NAME = exports2.GAME_ID = void 0;
    exports2.GAME_ID = "candy-carnage-1000";
    exports2.GAME_NAME = "Candy Carnage 1000";
    exports2.REELS = 6;
    exports2.VISIBLE_ROWS = 5;
    exports2.TOP_PADDING = 1;
    exports2.BOTTOM_PADDING = 1;
    exports2.TOTAL_ROWS_WITH_PADDING = exports2.VISIBLE_ROWS + exports2.TOP_PADDING + exports2.BOTTOM_PADDING;
    exports2.CLUSTER_MIN_SIZE = 8;
    exports2.INITIAL_FREE_SPINS = 10;
    exports2.RETRIGGER_SPINS = 5;
    exports2.MAX_WIN_MULTIPLIER = 25e3;
    exports2.PAY_SYMBOL_IDS = ["H1", "H2", "H3", "H4", "L1", "L2", "L3", "L4", "L5"];
    exports2.REGULAR_BOMB_VALUES = [2, 3, 4, 5, 6, 8, 10, 12, 15, 20, 25, 50, 100, 500, 1e3];
    exports2.SUPER_BOMB_VALUES = [20, 25, 50, 100, 500, 1e3];
    exports2.WIN_LEVELS = [
      ...
      { id: 9, name: "epic", min: 250, max: 1e3, animation: "epic" },
      { id: 10, name: "max", min: 1e3, max: null, animation: "max" }
    ];
    exports2.SCATTER_PAYOUTS = /* @__PURE__ */ new Map([
      [4, 0],
      [5, 5],
      [6, 100]
    ]);
...
// dist/games/candyCarnage1000/gameFlow.js
var require_gameFlow = __commonJS({
  "dist/games/candyCarnage1000/gameFlow.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.onHandleGameFlow = void 0;
    var core_1 = require_dist();
    var constants_1 = require_constants();
    var PAY_SYMBOL_SET = new Set(constants_1.PAY_SYMBOL_IDS);
    var BASE_REEL_INDICES = [...Array(constants_1.REELS).keys()];
    var ZERO_POSITIONS = [];
    var onHandleGameFlow = (ctx) => {
      resetUserData(ctx);
    ...
    exports2.onHandleGameFlow = onHandleGameFlow;
    function resetUserData(ctx) {
    ...
    function playBaseSpin(ctx) {
      ctx.state.currentSpinType = core_1.SPIN_TYPE.BASE_GAME;
      const forcedBonusType = ctx.state.currentResultSet.forceFreespins ? ctx.state.currentResultSet.userData?.forcedBonusType || "regular" : void 0;
      const outcome = playSpin(ctx, {
        spinType: core_1.SPIN_TYPE.BASE_GAME,
      ...
      if (outcome.triggeredBonus) {
        ...
        const forcedType = ctx.state.currentResultSet.userData?.forcedBonusType || "regular";
        startFreeSpins(ctx, forcedType, outcome.scatterInfo, { forced: true });
      }
    }
    function playFreeSpins(ctx) {
      const bonusType = ctx.state.userData.activeBonus;
      ctx.state.currentSpinType = core_1.SPIN_TYPE.FREE_SPINS;
      let freeSpinIndex = 0;
      ...
      while (ctx.state.currentFreespinAmount > 0) {
        ...
        const outcome = playSpin(ctx, {
          spinType: core_1.SPIN_TYPE.FREE_SPINS,
        ...
        if (ctx.services.wallet.getCurrentWin() >= constants_1.MAX_WIN_MULTIPLIER) {
          ctx.state.triggeredMaxWin = true;
          ctx.state.currentFreespinAmount = 0;
          ctx.state.userData.freespinsRemaining = 0;
          break;
    ...
    function handleBonusBuy(ctx, bonusType) {
      ctx.state.currentSpinType = core_1.SPIN_TYPE.BASE_GAME;
      playSpin(ctx, {
        spinType: core_1.SPIN_TYPE.BASE_GAME,
        allowScatterPayout: false,
    ...
    function playSpin(ctx, opts) {
      ...
      if (opts.spinType === core_1.SPIN_TYPE.FREE_SPINS) {
      ...
      if (opts.allowScatterPayout) {
        ...
        if (scatterPayout > 0) {
          ...
          recordScatterWin(ctx, scatterInfo, scatterPayout);
      ...
      while (true) {
        ...
        let bombSum = 0;
        if (opts.spinType === core_1.SPIN_TYPE.FREE_SPINS) {
          bombSum = clusters.flatMap((cluster) => cluster.bombPositions).reduce((sum, cell) => {
        ...
        totalTumbleWin += appliedWin;
        ctx.services.wallet.addTumbleWin(appliedWin);
        recordTumbleWin(ctx, appliedWin, totalTumbleWin, tumbleIndex);
        const clearedPositions = clusters.flatMap((cluster) => cluster.positions);
        const tumbleResult = ctx.services.board.tumbleBoard(clearedPositions.map((pos) => ({ reelIdx: pos.reel, rowIdx: pos.row })));
      ...
      recordSetTotalWin(ctx, totalTumbleWin, opts.spinType);
      if (ctx.services.wallet.getCurrentWin() >= constants_1.MAX_WIN_MULTIPLIER) {
        ctx.state.triggeredMaxWin = true;
      }
      const result = {
      ...
      if (opts.spinType === core_1.SPIN_TYPE.FREE_SPINS && scatterInfo.scatterCount >= 3) {
        result.retriggerSpins = constants_1.RETRIGGER_SPINS;
      }
      return result;
    }
    function evaluateClusters(ctx, spinType) {
      const board = ctx.services.board.getBoardReels();
      const visited = Array.from({ length: constants_1.REELS }, () => Array(constants_1.VISIBLE_ROWS).fill(false));
      const clusters = [];
      for (let reel = 0; reel < constants_1.REELS; reel++) {
        for (let row = 0; row < constants_1.VISIBLE_ROWS; row++) {
          if (visited[reel]?.[row])
            continue;
          const symbol = board[reel]?.[row];
          if (!symbol)
            continue;
          if (!PAY_SYMBOL_SET.has(symbol.id))
            continue;
          const cluster = floodFillCluster(ctx, board, { reel, row, symbol }, visited, spinType);
          if (cluster && cluster.matched >= constants_1.CLUSTER_MIN_SIZE && cluster.payout > 0) {
    ...
    function floodFillCluster(ctx, board, start, visited, spinType) {
      const queue = [start];
      const positions = [];
      const bombPositions = [];
      ...
      while (queue.length) {
        ...
        if (symbol.id === baseSymbolId) {
          matchedCount += 1;
        } else if (symbol.id === "M" && spinType === core_1.SPIN_TYPE.FREE_SPINS) {
          bombPositions.push(cell);
        }
        for (const neighbor of getNeighbors(board, reel, row)) {
          if (visited[neighbor.reel]?.[neighbor.row])
            continue;
      ...
      if (matchedCount < constants_1.CLUSTER_MIN_SIZE) {
        return null;
      }
      const baseSymbol = ctx.config.symbols.get(baseSymbolId);
    ...
    function shouldJoinCluster(symbol, baseSymbolId, spinType) {
      if (!symbol)
        return false;
      if (symbol.id === baseSymbolId)
        return true;
      if (symbol.id === "M" && spinType === core_1.SPIN_TYPE.FREE_SPINS)
        return true;
      return false;
    }
    function getNeighbors(board, reel, row) {
      const neighbors = [];
      const deltas = [
        [1, 0],
        [-1, 0],
      ...
      for (const [dx, dy] of deltas) {
        const nr = reel + dx;
        const nc = row + dy;
        if (nr >= 0 && nr < constants_1.REELS && nc >= 0 && nc < constants_1.VISIBLE_ROWS) {
    ...
    function assignBombMultipliers(ctx, bonusType) {
      const board = ctx.services.board.getBoardReels();
      const availableValues = bonusType === "super" ? constants_1.SUPER_BOMB_VALUES : constants_1.REGULAR_BOMB_VALUES;
      for (let reel = 0; reel < constants_1.REELS; reel++) {
        for (let row = 0; row < constants_1.VISIBLE_ROWS; row++) {
          const symbol = board[reel]?.[row];
    ...
    function determineBonusTrigger(info) {
    ...
    function getScatterInfo(ctx) {
      const board = ctx.services.board.getBoardReels();
      const scatterPositions = [];
      const superScatterPositions = [];
      for (let reel = 0; reel < constants_1.REELS; reel++) {
    ...
    function startFreeSpins(ctx, type, scatterInfo, options) {
      ctx.state.userData.activeBonus = type;
      ctx.state.userData.freespinsRemaining = constants_1.INITIAL_FREE_SPINS;
      ctx.state.userData.totalBonusSpinsAwarded = constants_1.INITIAL_FREE_SPINS;
      ctx.services.game.awardFreespins(constants_1.INITIAL_FREE_SPINS);
      ctx.state.triggeredFreespins = true;
      recordFreeSpinTrigger(ctx, scatterInfo, type, options);
    }
    function recordReveal(ctx, spinType) {
      ctx.services.data.addBookEvent({
        type: "reveal",
        data: {
          gameType: spinType === core_1.SPIN_TYPE.BASE_GAME ? "basegame" : "freegame",
          board: serializeBoard(ctx.services.board.getBoardReels()),
          paddingTop: serializeBoard(ctx.services.board.getPaddingTop()),
          paddingBottom: serializeBoard(ctx.services.board.getPaddingBottom())
        }
      });
    }
    function recordClusterWin(ctx, clusters, tumbleIndex, spinType) {
      ctx.services.data.addBookEvent({
        type: "winInfo",
        data: {
          tumble: tumbleIndex,
          ...
          clusters: clusters.map((cluster) => ({
            ...
            bombPositions: serializePositions(cluster.bombPositions)
          }))
        }
      });
    }
    function recordTumbleWin(ctx, amount, total, tumbleIndex) {
      ctx.services.data.addBookEvent({
    ...
    function recordBombMultiplier(ctx, clusters, tumbleWin, boardMultiplier, totalWin) {
      ctx.services.data.addBookEvent({
        type: "boardMultiplierInfo",
        data: {
          multInfo: {
            positions: clusters.flatMap((cluster) => cluster.bombPositions).map((cell) => ({
              reel: cell.reel,
              row: cell.row,
              name: cell.symbol.id,
    ...
    function recordTumbleBoard(ctx, cleared, tumbleResult) {
      ctx.services.data.addBookEvent({
        type: "tumbleBoard",
        data: {
          cleared: serializePositions(cleared),
          newSymbols: Object.entries(tumbleResult.newBoardSymbols ?? {}).map(([reel, symbols]) => ({
            reel: Number(reel),
            symbols: symbols.map((sym) => sym.id)
          })),
          newTopPadding: Object.entries(tumbleResult.newPaddingTopSymbols ?? {}).map(([reel, symbols]) => ({
            reel: Number(reel),
            symbols: symbols.map((sym) => sym.id)
          }))
        }
    ...
    function recordScatterWin(ctx, scatterInfo, payout) {
      ctx.services.data.addBookEvent({
        type: "scatterWin",
        data: {
          payout,
    ...
    function recordSetTotalWin(ctx, amount, spinType) {
      ctx.services.data.addBookEvent({
        type: "setTotalWin",
        data: {
          amount,
    ...
    function recordUpdateFreeSpin(ctx, spinIndex) {
      ctx.services.data.addBookEvent({
        type: "updateFreeSpin",
        data: {
          spin: spinIndex,
          remaining: ctx.state.currentFreespinAmount,
          totalAwarded: ctx.state.userData.totalBonusSpinsAwarded
        }
      });
    }
    function recordRetrigger(ctx, added) {
      ctx.services.data.addBookEvent({
    ...
    function recordFreeSpinTrigger(ctx, scatterInfo, type, options) {
      ctx.services.data.addBookEvent({
        ...
        data: {
          ...
          skipPayout: Boolean(options?.skipPayout)
        }
      });
      ctx.services.data.addBookEvent({
        type: "enterBonus",
    ...
    function recordFreeSpinEnd(ctx, amount) {
      ctx.services.data.addBookEvent({
        type: "freeSpinEnd",
        data: {
          amount,
    ...
    function finalizeSimulation(ctx) {
    ...
    function getWinLevel(amount) {
      for (const level of constants_1.WIN_LEVELS) {
    ...
    function serializeBoard(board) {
      return board.map((reel) => reel.map((symbol) => symbol?.id ?? ""));
    }
    function serializePositions(positions = ZERO_POSITIONS) {
      return positions.map((pos) => ({
        reel: pos.reel,
        row: pos.row,
        symbol: pos.symbol.id
      }));
    }
    function forceScatterLayout(ctx, bonusType) {
...
// dist/games/candyCarnage1000/reels.js
var require_reels = __commonJS({
  "dist/games/candyCarnage1000/reels.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.getReelsForMode = getReelsForMode;
    var BASE_REELS = [
      [
        "L1",
        "L3",
    ...
    var BONUS_HUNT_REELS = BASE_REELS.map((reel, idx) => {
    ...
    var REGULAR_BONUS_REELS = BASE_REELS.map((reel) => addBombsWithoutSuperScatter(reel, 3));
    var SUPER_BONUS_REELS_PER_REEL = BASE_REELS.map((reel, idx) => emphasizePremiums(addBombsWithoutSuperScatter(reel, 5 + idx % 2)));
    var MODE_BASE_REELS = {
      base: BASE_REELS,
...
// dist/games/candyCarnage1000/config.js
var require_config = __commonJS({
  "dist/games/candyCarnage1000/config.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.userState = exports2.symbols = exports2.gameModes = exports2.candyCarnage1000Game = void 0;
    var core_1 = require_dist();
    var constants_1 = require_constants();
    var gameFlow_1 = require_gameFlow();
    var reels_1 = require_reels();
    var SYMBOLS_PER_REEL = Array.from({ length: constants_1.REELS }, () => constants_1.VISIBLE_ROWS);
    var createClusterPays = (tiers) => {
      const pays = {};
    ...
    var symbols = (0, core_1.defineSymbols)({
    ...
    var userState = (0, core_1.defineUserState)({
      activeBonus: null,
    ...
    var createReelSet = (id, reels) => new core_1.StaticReelSet({
      id,
      reels
    });
    var createResultSet = (criteria, baseReelId, bonusReelId, overrides = {}) => new core_1.ResultSet({
      criteria,
      quota: 1,
      reelWeights: {
    ...
    var gameModes = (0, core_1.defineGameModes)({
    ...
    exports2.gameModes = gameModes;
    var scatterToFreespins = {
    ...
    exports2.candyCarnage1000Game = (0, core_1.createSlotGame)({
...
// dist/slotEngineRunner.js
var require_slotEngineRunner = __commonJS({
  "dist/slotEngineRunner.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.runSlotEngineSimulation = runSlotEngineSimulation;
    exports2.autoRunSlotEngineWorker = autoRunSlotEngineWorker;
    ...
    async function runSlotEngineSimulation() {
      config_12.candyCarnage1000Game.configureSimulation({
        simRunsAmount: SIM_RUNS,
        concurrency: 4
      });
      if (worker_threads_1.isMainThread) {
        const simulationConfig = config_12.candyCarnage1000Game.simulation;
        ...
        console.log("[slot-engine] game modes", Object.keys(config_12.candyCarnage1000Game.getConfig().gameModes));
        console.log("[slot-engine] rootDir", config_12.candyCarnage1000Game.getConfig().rootDir);
      }
      await config_12.candyCarnage1000Game.runTasks({
        doSimulation: true,
...
Object.defineProperty(exports, "candyCarnage1000Game", { enumerable: true, get: function() {
  return config_1.candyCarnage1000Game;
} });
var slotEngineRunner_1 = require_slotEngineRunner();
