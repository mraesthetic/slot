...
exports.onHandleGameFlow = void 0;
const core_1 = require("@slot-engine/core");
const constants_1 = require("./constants");
const PAY_SYMBOL_SET = new Set(constants_1.PAY_SYMBOL_IDS);
const BASE_REEL_INDICES = [...Array(constants_1.REELS).keys()];
const ZERO_POSITIONS = [];
const onHandleGameFlow = (ctx) => {
    resetUserData(ctx);
...
exports.onHandleGameFlow = onHandleGameFlow;
...
function playBaseSpin(ctx) {
    ...
    const forcedBonusType = ctx.state.currentResultSet.forceFreespins
        ? (ctx.state.currentResultSet.userData?.forcedBonusType || 'regular')
        : undefined;
